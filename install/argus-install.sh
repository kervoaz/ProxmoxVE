...
service:
  ...
  kervoaz/ProxmoxVE:
    latest_version:
      type: github
      url: kervoaz/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/kervoaz/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/kervoaz/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
