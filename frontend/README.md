...
> 🚀 **Modern frontend for the kervoaz Proxmox VE Helper-Scripts repository**

A comprehensive, user-friendly interface built with Next.js that provides access to 300+ automation scripts for Proxmox Virtual Environment management. This frontend serves as the official website for the kervoaz organization's Proxmox VE Helper-Scripts repository.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/kervoaz/ProxmoxVE.git
...
- **[kervoaz Organization](https://github.com/kervoaz)** - Maintaining and expanding the project
...
- **[Community Scripts Repository](https://github.com/kervoaz/ProxmoxVE)**
- **[Discord Community](https://discord.gg/2wvnMDgdnU)**
- **[GitHub Discussions](https://github.com/kervoaz/ProxmoxVE/discussions)**

## 🔗 Links

- **🌐 Live Website**: [https://kervoaz.github.io/ProxmoxVE/](https://kervoaz.github.io/ProxmoxVE/)
- **💬 Discord Server**: [https://discord.gg/2wvnMDgdnU](https://discord.gg/2wvnMDgdnU)
- **📝 Change Log**: [https://github.com/kervoaz/ProxmoxVE/blob/main/CHANGELOG.md](https://github.com/kervoaz/ProxmoxVE/blob/main/CHANGELOG.md)

---

**Made with ❤️ by the kervoaz team and contributors**
