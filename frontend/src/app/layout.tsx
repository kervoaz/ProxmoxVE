...
export const metadata: Metadata = {
  ...
  authors: [
    ...
    { name: "Community Scripts", url: "https://github.com/kervoaz" },
  ],
  creator: "Bram Suurd",
  publisher: "Community Scripts",
  metadataBase: new URL(`https://kervoaz.github.io/${basePath}/`),
  alternates: {
    canonical: `https://kervoaz.github.io/${basePath}/`,
  },
  viewport: {
    width: "device-width",
    initialScale: 1,
  ...
  openGraph: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) Repository. Featuring over 300+ scripts to help you manage your Proxmox VE environment.",
    url: `https://kervoaz.github.io/${basePath}/`,
    siteName: "Proxmox VE Helper-Scripts",
    images: [
      {
        url: `https://kervoaz.github.io/${basePath}/defaultimg.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) Repository. Featuring over 300+ scripts to help you manage your Proxmox VE environment.",
    images: [`https://kervoaz.github.io/${basePath}/defaultimg.png`],
  },
