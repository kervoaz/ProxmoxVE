...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/kervoaz/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.kervoaz.org/kervoaz/${basePath}/raw/branch/main/${scriptPath}`;
